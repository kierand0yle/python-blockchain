...
class Transaction:
  """
  Document of an exchange in currenty to a sender from one
  or more recipients
  """
  ...
  def create_input(self, sender_wallet, output):
      """
      Structure the input data for the txn
      Sign the txn and include the sender's public key and address
      """
  ...
  def from_json(transaction_json):
    '''
    Deserialise a txn's json represenation back into
    a Txn instance
    '''
  ...
  def reward_transaction(miner_wallet):
    '''
    Generate a reward txn that awards the miner
    '''
    output = {}
